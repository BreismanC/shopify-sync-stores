      ...
      <main className="flex w-full max-w-md flex-col items-center justify-center">
        <Card className="w-full rounded-xl border border-outline-variant bg-surface-container-lowest p-6 sm:p-8 shadow-none">
          <div className="flex flex-col items-center mb-8 gap-2">
            <h1 className="text-on-background tracking-tight text-3xl font-extrabold leading-tight text-center font-sans">
              Inicia sesión
            </h1>
              ...
              <div className="relative w-full">
                ...
                >
                  <Input
                    ...
                    className="w-full h-12 bg-surface-container-low pr-10 focus:ring-primary"
                ...
                <div className="mt-4 text-sm">
                  <Link
                    ...
                    className="text-on-surface-variant underline font-light"
                  >
          ...
          <div className="mt-8 space-y-4">
            <div className="relative flex items-center">
              ...
              <span className="mx-4 flex-shrink text-sm text-on-surface-variant">
                o
              </span>
              <div className="flex-grow border-t border-outline-variant"></div>
            </div>
